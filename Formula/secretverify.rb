class Secretverify < Formula
  ...
  resource "requests" do
    url "https://files.pythonhosted.org/packages/xx/yy/requests-2.31.0.tar.gz"
    sha256 "942c5a758f98d790eaed1a29cb6eefc7ffb0d1cf7af05c3d2791656dbd6ad1e1"
  end

  resource "boto3" do
    url "https://files.pythonhosted.org/packages/aa/bb/boto3-1.26.151.tar.gz"
    sha256 "81bff32c96a6b4b203beb63826214d8cf24ca1a86e81d43bbb688a21c5d79e2a"
  end

  resource "google-auth" do
    url "https://files.pythonhosted.org/packages/cc/dd/google-auth-2.23.0.tar.gz"
    sha256 "753a26312e6f1eaeec20bc6f2644a10926697da93446e1f8e24d6d32d45a922a"
  end

  resource "PyInquirer" do
    url "https://files.pythonhosted.org/packages/ee/ff/PyInquirer-1.0.3.tar.gz"
